//! Frozen pre-improvement rival, retained only as a competitive benchmark opponent.
//! Its constants and heuristics intentionally remain independent of the live AI.
...
#[derive(Debug)]
pub(crate) struct LegacyRivalAi {
    nodes: Vec<NavNode>,
    path: Vec<usize>,
    next: usize,
    replan_seconds: f32,
